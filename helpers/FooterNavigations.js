export const navigation = {
  company: [
    ...
    { name: "Blog", href: "http://blog.rootlogic.tech/", newTab: true },
    { name: "Careers", href: "/careers" },
    { name: "Contact Us", href: "/contactUs" },
  ],
  services: [
    { name: "Full-stack Web Development", href: "/services?#1" },
    { name: "Mobile App Development", href: "/services?#2" },
    { name: "Digital Transformation", href: "/services?#3" },
    { name: "CMS Development", href: "/services?#4" },
    { name: "eCommerce Solutions", href: "/services?#5" },
    { name: "Managed Services", href: "/services?#6" },
  ],
