...
function CaseStudies({ heading, data }) {
  ...
  const settings = {
    ...
    prevArrow: (
      <div className="focus:outline-none">
        <div className="z-10 w-16 h-16 hidden sm:flex rounded-full bg-white shadow-2xl  flex-row items-center justify-center">
  ...
  return (
    <div className="ml-3 mr-10 px-7 py-12 md:py-20 max-w-6xl xl:mx-auto">
